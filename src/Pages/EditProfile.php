...
class EditProfile extends PagesEditProfile
{
    ...
    public function form(Schema $schema): Schema
    {
        ...
        if (method_exists($class, 'getProfileForm')) {
            return $class::getProfileForm($schema);
        }
    ...
    public function save(): void
    {
        ...
        $this->redirect(Filament::getCurrentPanel()->getLoginUrl(), navigate: FilamentView::hasSpaMode() && URL::is(Filament::getCurrentPanel()->getLoginUrl()));
    }
}
